export const fr = {
  ...
  contact: {
    ...
    help_text:
      "Des questions? Nous sommes là pour vous aider à trouver la solution parfaite.",
  },
  about: {
  ...
  products: {
    title: "San Water Produits",
    description: "Découvrez notre collection complète de produits San Water.",
    ...
    no_products_found_description:
      "Les produits que vous recherchez sont introuvables.",
    ...
    compare_full:
      "Votre liste de comparaison est pleine. Retirez un produit pour en ajouter un autre.",
  ...
  compare_page: {
    ...
    empty_description:
      "Ajoutez des produits à votre liste de comparaison depuis le catalogue pour les voir côte à côte ici.",
  ...
  favorites_page: {
    ...
    empty_description:
      "Cliquez sur l'icône cœur d'un produit pour l'enregistrer ici.",
    browse_products: "Parcourir les produits",
    unavailable_notice:
      "Ce produit n'est plus disponible et a été retiré de vos favoris.",
  },
  contact_sales: {
  ...
  hiring: {
    ...
    contact_hiring_team: "Contacter l’équipe de recrutement",
    open_roles: "Postes ouverts",
    locations: "Localisations",
    role_types: "Types de postes",
    next_step: "Étape suivante",
    find_your_fit: "Trouvez le poste qui vous correspond",
    search_label: "Recherche",
    search_text:
      "Filtrez les postes par intitulé, localisation ou type de poste.",
    refine_label: "Affiner",
    refine_text:
      "Ajustez les résultats selon la localisation et le type de poste.",
    updated_label: "Mis à jour",
    latest_post: "Dernière publication : {{date}}",
    search_placeholder: "Rechercher un poste...",
    all_locations: "Toutes les localisations",
    all_types: "Tous les types",
    newest: "Les plus récents",
    title_az: "Intitulé A → Z",
    location_az: "Localisation A → Z",
    type_az: "Type A → Z",
    refresh: "Actualiser",
    open_positions: "Postes à pourvoir",
    role_available: "{{count}} poste disponible.",
    roles_available: "{{count}} postes disponibles.",
    new_roles_appear: "Les nouveaux postes apparaissent automatiquement ici",
    open: "Ouvert",
    draft: "Brouillon",
    closed: "Fermé",
    featured: "À la une",
    loading_opportunities: "Chargement des opportunités...",
    no_open_positions: "Aucun poste ouvert pour le moment",
    no_roles_match_search: "Aucun poste ne correspond à votre recherche",
    no_open_positions_text:
      "Nous publierons ici de nouvelles opportunités dès qu’elles seront disponibles.",
    no_roles_match_search_text:
      "Essayez un autre mot-clé ou réinitialisez les filtres pour découvrir davantage d’opportunités.",
    send_cv_anyway: "Envoyer tout de même votre CV",
    apply_now: "Postuler maintenant",
    fast_response: "Réponse rapide de l’équipe de recrutement",
  },
  whatsapp: {
    default_message:
      "Bonjour! J'aimerais en savoir plus sur les produits San Water.",
  ...
  news: {
    ...
    seo_title: "Dernières Nouvelles | San Water",
    seo_description:
      "Restez informé des dernières nouvelles et annonces de San Water.",
  },
};
